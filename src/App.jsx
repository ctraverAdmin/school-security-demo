 ...
 const buildingZones = {
  ...
  const demoModes = {
    ...
    visitor: {
      ...
      summary: "Give your front-desk team the ability to verify visitors, communicate clearly, and control entry from a single, simple interface.",
      stats: ["Video intercom verification", "Remote unlock decision", "Automatic event recording"],
      timeline: ["Visitor arrives", "Office sees live video", "Two-way talk begins", "Door is granted or denied"],
    },
    lockdown: {
      title: "Emergency Response Demo",
      summary: "See how cameras, doors, and audio work together to give your team faster, more confident control when every second counts.",
      stats: ["Immediate live visibility", "Fast communication", "Coordinated building response"],
      timeline: ["Incident detected", "Relevant cameras display", "Audio instruction plays", "Staff act from one interface"],
    },
    afterhours: {
      title: "After-Hours Protection Demo",
      summary: "Stay in control of entrances, athletic spaces, and parking areas even after hours with clear visibility and response tools.",
      stats: ["Scheduled door control", "Exterior monitoring", "Recorded event review"],
      timeline: ["Door event occurs", "Camera verifies activity", "Staff receive alert", "Response is documented"],
    },
  };
  ...
  const cloudTabs = {
    overview: {
      ...
      blurb: "Connect your devices into a managed cloud layer so your team can access, manage, and respond from anywhere with confidence.",
      bullets: ["Remote video and event access", "Managed device lifecycle", "Secure cloud-connected workflows"],
    },
    operations: {
      title: "Daily Operations",
      blurb: "Use the cloud layer to simplify monitoring, device health, updates, and access to live and recorded events.",
      bullets: ["Browser-based access", "Faster onboarding and provisioning", "Consistent system availability"],
    },
    response: {
      title: "Response & Continuity",
      blurb: "Keep decision-makers connected to cameras, events, and alerts even when they are not sitting at a local workstation.",
      bullets: ["Anywhere access", "Centralized event awareness", "Scalable multi-site management"],
    },
  };
    ...
    <div className="min-h-screen overflow-hidden bg-black text-white">
      <section className="relative flex min-h-screen items-center justify-center overflow-hidden">
        ...
        <div className="relative w-full px-6 py-20 md:px-10">
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} className="grid items-center gap-12 lg:grid-cols-[1.1fr_0.9fr]">
            <div>
              <div className="mb-16 flex items-center gap-6">
                <img src="/logo.png" alt="Northeast Data" className="h-auto max-h-20 md:max-h-28 w-auto object-contain" />
                <div>
                  <div className="text-3xl md:text-5xl font-black tracking-tight text-white leading-tight">
                    Northeast Data
                  </div>
                  <div className="mt-1 text-base md:text-lg font-medium text-zinc-400">
              ...
              <div className="mt-10 flex flex-wrap gap-4">
                <a href="#simulation" className="rounded-xl bg-amber-300 px-8 py-4 text-base font-black uppercase tracking-[0.18em] text-black transition hover:scale-[1.02]">
                  Launch Simulation
                </a>
                <a href="#map" className="rounded-xl border border-white/20 px-8 py-4 text-base font-bold uppercase tracking-[0.18em] text-white transition hover:bg-white/5">
                  Explore Building Map
                </a>
                <a href="mailto:nedatainfo@northeastdata.com?subject=School%20Security%20Walkthrough" className="rounded-xl border border-amber-300/40 bg-black/30 px-8 py-4 text-base font-bold uppercase tracking-[0.18em] text-amber-200 transition hover:bg-amber-300/10">
                  Book a Walkthrough
                </a>
              </div>

              <div className="mt-10 grid w-full gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
                {valuePoints.map((item) => (
                  <div key={item.title} className="group rounded-2xl border border-white/10 bg-black/35 p-5 backdrop-blur transition hover:scale-[1.03] hover:border-amber-300/40 hover:shadow-lg hover:shadow-amber-300/10">
                    <div className="text-3xl mb-3">{item.icon}</div>
                    <div className="text-sm font-black uppercase tracking-[0.18em] text-amber-300">{item.title}</div>
            ...
            <motion.div initial={{ opacity: 0, scale: 0.96 }} animate={{ opacity: 1, scale: 1 }} className="rounded-[2rem] border border-white/10 bg-white/5 p-6 shadow-2xl backdrop-blur">
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-xs font-bold uppercase tracking-[0.28em] text-amber-300">Sales Demo Preview</div>
                  <div className="mt-2 text-2xl font-black">One platform. Multiple layers of response.</div>
                </div>
                <div className="rounded-full bg-amber-300 px-4 py-2 text-xs font-black uppercase tracking-[0.22em] text-black">Live</div>
              </div>
              ...
              <div className="mt-6 space-y-4">
                {[
                  ...
                  <div key={item} className="rounded-2xl border border-white/10 bg-black/35 p-4 text-lg font-semibold text-zinc-100">
                    {item}
                  </div>
                ))}
              </div>
              ...
              <div className="mt-6 rounded-2xl border border-amber-300/20 bg-amber-300/10 p-4">
                <div className="text-xs font-black uppercase tracking-[0.2em] text-amber-200">Why this matters to you</div>
                <p className="mt-2 text-sm leading-6 text-zinc-100">
                  This gives you a clear way to see risk, understand how your building responds, and feel confident in how your team can act—without getting buried in technical details.
                </p>
              </div>
            </motion.div>
          </motion.div>
      ...
      <section id="simulation" className="px-6 py-24 md:px-10">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center">
            <div className="text-xs font-bold uppercase tracking-[0.3em] text-amber-300">Live Simulation</div>
            <h2 className="mt-4 text-4xl font-black md:text-6xl">Walk through a real-time security event</h2>
            <p className="mx-auto mt-5 max-w-3xl text-lg leading-8 text-zinc-300">
              Click through the sequence and show exactly how the system detects, verifies, communicates, and responds.
            </p>
          </div>
          ...
          <div className="grid gap-8 lg:grid-cols-[0.95fr_1.05fr]">
            <div className="rounded-[2rem] border border-white/10 bg-zinc-950 p-6 shadow-xl">
              <div className="mb-5 flex items-center justify-between">
                <div>
                  <div className="text-xs font-bold uppercase tracking-[0.24em] text-zinc-500">Incident Progress</div>
                  <div className="mt-2 text-2xl font-black">Simulation Timeline</div>
                </div>
                <div className="text-sm font-bold text-amber-300">{activeStep + 1} / {steps.length}</div>
              </div>

              <div className="mb-6 h-2 rounded-full bg-white/10">
                <motion.div className="h-2 rounded-full bg-amber-300" animate={{ width: `${progress}%` }} />
              </div>
              ...
              <div className="space-y-3">
                {steps.map((step, i) => (
                  ...
                  >
                    <div className={`mt-1 h-3 w-3 rounded-full ${activeStep === i ? "bg-black" : step.color}`} />
                    <div>
                      <div className="text-xs font-black uppercase tracking-[0.2em] opacity-80">Step {i + 1}</div>
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <div className="flex items-center justify-between gap-4">
                  <div>
                    <div className="text-xs font-bold uppercase tracking-[0.28em] text-amber-300">Current Event</div>
                ...
                <p className="mt-6 max-w-2xl text-xl leading-8 text-zinc-200">{steps[activeStep].desc}</p>
                ...
                <div className="mt-10 grid gap-4 md:grid-cols-3">
                  {[
                    ...
                    <div key={item} className="rounded-2xl border border-white/10 bg-black/25 p-4 text-sm font-semibold text-zinc-100">
                      {item}
                    </div>
                  ))}
                </div>
                ...
                <div className="mt-8 rounded-2xl border border-amber-300/20 bg-black/25 p-5">
                  <div className="text-xs font-black uppercase tracking-[0.22em] text-amber-300">What this means for you</div>
      ...
      <section id="map" className="bg-zinc-950 px-6 py-24 md:px-10">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center">
            <div className="text-xs font-bold uppercase tracking-[0.3em] text-amber-300">Clickable Building Map</div>
            <h2 className="mt-4 text-4xl font-black md:text-6xl">Explore how security works across the entire building</h2>
            <p className="mx-auto mt-5 max-w-3xl text-lg leading-8 text-zinc-300">
              Click a zone to explain the risks, the recommended technology, and the practical outcome for that area.
            </p>
          </div>
          ...
          <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
            <div className="relative min-h-[560px] rounded-[2rem] border border-white/10 bg-[linear-gradient(180deg,#1c1c1f,#0c0c0d)] p-6 shadow-2xl">
              ...
              <div className="relative h-full min-h-[500px] rounded-[1.5rem] border border-white/10 bg-black/30">
                ...
                <div className="absolute left-[40%] top-[44%] h-[34%] w-[22%] rounded-2xl border border-white/10 bg-white/5" />
                ...
                <div className="absolute left-[12%] top-[48%] h-[8%] w-[6%] rounded-lg border border-amber-300/50 bg-amber-300/15" />
                ...
                {Object.entries(buildingZones).map(([key, item]) => (
                  ...
                  >
                    <div className={`relative flex h-6 w-6 items-center justify-center rounded-full border-4 ${selectedZone === key ? "border-amber-300 bg-amber-300" : "border-white bg-black"}`}>
                      <div className={`h-2.5 w-2.5 rounded-full ${selectedZone === key ? "bg-black" : "bg-amber-300"}`} />
                      <div className={`absolute h-10 w-10 rounded-full ${selectedZone === key ? "animate-ping bg-amber-300/20" : "bg-transparent"}`} />
                    </div>
                  </button>
                ))}
  ...
  >
    ...
    <div className="mt-8 rounded-2xl border border-amber-300/20 bg-amber-300/10 p-5">
      ...
      <section className="bg-zinc-950/70 px-6 py-24 md:px-10">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center">
            <div className="text-xs font-bold uppercase tracking-[0.3em] text-amber-300">Cloud Solution Layer</div>
            <h2 className="mt-4 text-4xl font-black md:text-6xl">Extend your security system with cloud-based connectivity and control</h2>
            <p className="mx-auto mt-5 max-w-3xl text-lg leading-8 text-zinc-300">
              Move beyond stand-alone hardware and present a smarter, more scalable security platform. Connect devices, events, and management through the cloud so schools gain easier access, stronger visibility, and greater operational control.
            </p>
          </div>
          ...
          <div className="grid gap-8 lg:grid-cols-[1.08fr_0.92fr]">
            <div className="rounded-[2rem] border border-white/10 bg-[linear-gradient(180deg,#17171a,#09090b)] p-6 shadow-2xl">
              <div className="mb-5 flex items-center justify-between">
                <div>
                  <div className="text-xs font-bold uppercase tracking-[0.24em] text-amber-300">How it works</div>
              ...
              <div className="relative min-h-[540px] rounded-[1.6rem] border border-white/10 bg-black/35 p-6">
                <div className="grid h-full min-h-[500px] gap-6 lg:grid-cols-[1fr_auto_1fr]">
                  <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
                    <div className="text-sm font-black uppercase tracking-[0.2em] text-amber-300">At the School</div>
                  ...
                  <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
                    <div className="text-sm font-black uppercase tracking-[0.2em] text-amber-300">People &amp; Apps</div>
                    <div className="mt-3 grid gap-3 text-sm text-zinc-200">
                  ...
                  <div className="lg:col-span-3">
                    <div className="mx-auto max-w-md rounded-2xl border border-amber-300/30 bg-amber-300/10 p-5 text-center shadow-lg shadow-amber-300/10">
                      <div className="text-sm font-black uppercase tracking-[0.2em] text-amber-200">Cloud Layer</div>
                      <div className="mt-3 text-3xl font-black text-white">Axis Cloud Connect</div>
                      <div className="mt-3 text-sm leading-7 text-zinc-200">Managed services, remote connectivity, lifecycle workflows, and secure access.</div>
                    </div>
                  </div>

                  <div className="lg:col-span-3 flex justify-center">
                    <div className="hidden lg:block text-3xl font-black text-amber-200">↓</div>
                  </div>

                  <div className="lg:col-span-3">
                    <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
                      <div className="text-sm font-black uppercase tracking-[0.2em] text-amber-300">Outcomes</div>
            ...
            <div className="space-y-4">
              {Object.entries(cloudTabs).map(([key, value]) => (
                ...
                >
                  <div className="text-xs font-black uppercase tracking-[0.24em] opacity-75">Cloud View</div>
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  <div className="text-xs font-bold uppercase tracking-[0.28em] text-amber-300">What this gives you</div>
                  <h3 className="mt-3 text-3xl font-black">{cloud.title}</h3>
                  <p className="mt-4 text-lg leading-8 text-zinc-200">
                    This gives your team easier access to critical information, better visibility across your systems, and the ability to manage everything without being tied to a single location.
                  </p>
                  <div className="mt-6 grid gap-3">
                    {cloud.bullets.map((item) => (
                      <div key={item} className="rounded-xl border border-white/10 bg-black/25 px-4 py-3 text-sm font-semibold text-zinc-100">
                        {item}
                      </div>
                    ))}
                  </div>
                  ...
                  <div className="mt-6 rounded-2xl border border-amber-300/20 bg-black/20 p-4">
                    <div className="text-xs font-black uppercase tracking-[0.22em] text-amber-300">Executive takeaway</div>
                    <p className="mt-2 text-sm leading-6 text-zinc-100">
                      The cloud layer helps position the solution as easier to manage, easier to access, and better suited for future growth.
                    </p>
                  </div>
                </motion.div>
              </AnimatePresence>
      ...
      <section className="px-6 py-24 md:px-10">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center">
            <div className="text-xs font-bold uppercase tracking-[0.3em] text-amber-300">Interactive Security Scenarios</div>
            <h2 className="mt-4 text-4xl font-black md:text-6xl">Choose the scenario that matters most to your school</h2>
            <p className="mx-auto mt-5 max-w-3xl text-lg leading-8 text-zinc-300">
              Explore how your system performs during everyday operations, emergency situations, and after-hours activity—so you can see exactly how it supports your staff and protects your building.
            </p>
          </div>
          ...
          <div className="grid gap-8 lg:grid-cols-[0.42fr_0.58fr]">
            <div className="space-y-4">
              {Object.entries(demoModes).map(([key, value]) => (
                ...
                >
                  <div className="text-xs font-black uppercase tracking-[0.24em] opacity-75">Demo Mode</div>
                  <div className="mt-2 text-2xl font-black">{value.title}</div>
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <div className="flex flex-wrap items-center justify-between gap-4">
                  <div>
                    <div className="text-xs font-bold uppercase tracking-[0.28em] text-amber-300">Current Demo</div>
                ...
                <div className="mt-8 grid gap-4 md:grid-cols-3">
                  {demo.stats.map((stat) => (
                    <div key={stat} className="rounded-2xl border border-white/10 bg-black/25 p-4 text-sm font-bold text-zinc-100">
                      {stat}
                    </div>
                  ))}
                </div>
                ...
                <div className="mt-8 rounded-2xl border border-white/10 bg-black/25 p-6">
                  <div className="mb-4 grid gap-3 md:grid-cols-2">
                    {objectionPoints.slice(0,2).map((item) => (
                      <div key={item} className="rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-sm font-semibold text-zinc-100">
                        {item}
                      </div>
                    ))}
                  </div>
                  <div className="text-xs font-bold uppercase tracking-[0.24em] text-amber-300">Suggested Talk Track</div>
                  <div className="mt-4 grid gap-3">
                    {demo.timeline.map((item, i) => (
                      <div key={item} className="flex items-center gap-4 rounded-xl border border-white/10 bg-white/5 px-4 py-3">
                        <div className="flex h-8 w-8 items-center justify-center rounded-full bg-amber-300 text-sm font-black text-black">{i + 1}</div>
      ...
      <section className="px-6 py-16 md:px-10">
        <div className="mx-auto max-w-7xl rounded-[2rem] border border-white/10 bg-white/5 p-8 shadow-xl">
          <div className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
            <div>
              <div className="text-xs font-bold uppercase tracking-[0.28em] text-amber-300">Key Reasons Schools Buy</div>
              <h2 className="mt-3 text-3xl font-black md:text-5xl">A better security story for administrators, operations teams, and decision-makers</h2>
            </div>
            <div className="grid gap-3 sm:grid-cols-2">
              {objectionPoints.map((item) => (
                <div key={item} className="rounded-xl border border-white/10 bg-black/25 px-4 py-4 text-sm font-semibold text-zinc-100">
                  {item}
                </div>
              ))}
            </div>
      ...
      <section className="px-6 pb-28 pt-8 text-center md:px-10">
        <div className="mx-auto max-w-5xl rounded-[2.5rem] border border-amber-300/20 bg-[linear-gradient(135deg,rgba(251,191,36,0.18),rgba(0,0,0,0.96))] p-10 shadow-2xl md:p-14">
          <div className="text-xs font-bold uppercase tracking-[0.32em] text-amber-300">Next Step</div>
          <h2 className="mt-4 text-4xl font-black md:text-6xl">See exactly how this would work in your school.</h2>
          <p className="mx-auto mt-6 max-w-3xl text-lg leading-8 text-zinc-200">
            Most schools don’t realize where their biggest security gaps are until after something happens. A walkthrough gives you a clear, real-world view of your risks—and exactly how your team can respond faster, communicate better, and stay in control.
          </p>
          ...
          <div className="mt-10">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <a href="mailto:nedatainfo@northeastdata.com" className="rounded-xl bg-amber-300 px-8 py-4 text-base font-black uppercase tracking-[0.18em] text-black transition hover:scale-[1.02]">
                Schedule Your Security Walkthrough
              </a>
              <a href="#simulation" className="rounded-xl border border-white/20 px-8 py-4 text-base font-bold uppercase tracking-[0.18em] text-white transition hover:bg-white/5">
                Restart Demo
              </a>
            </div>
          </div>
