...
export default function AxisSchoolSecurityBrochure() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#efefea] text-[#1f2937]">
      <div className="pointer-events-none fixed left-0 top-0 z-0 h-full w-[48px] bg-[#b32025]" />
      ...
      <div className="pointer-events-none fixed inset-0 z-0 flex items-center justify-center opacity-[0.09]">
        <img
          ...
          className="w-[760px] max-w-[78%] object-contain grayscale"
        />
      </div>
  ...
  <div className="text-3xl font-black uppercase tracking-[0.28em] text-red-700">
  ...
  <div className="mt-4 grid gap-3 sm:grid-cols-2">
    {[
      ...
      <div
        key={item}
        className="flex items-start gap-3 rounded-xl border border-red-300 bg-red-50 px-5 py-4 text-lg font-bold text-red-700"
      >
  ...
  {[
    { label: "A guided incident simulation", link: "#simulation" },
    { label: "A clickable school security map", link: "#map" },
    { label: "A cloud-connected operations overview", link: "#Cloud Solution Layer" },
    { label: "Practical reasons schools buy", link: "#why" },
  ].map((item) => (
    <a
      key={item.label}
      href={item.link}
      className="block rounded-2xl border border-[#ece7cf] bg-[#faf8ef] p-4 text-base font-semibold text-[#1f2937] transition hover:bg-[#fff6c9] hover:-translate-y-0.5 cursor-pointer"
    >
      {item.label}
    </a>
  ))}
  ...
  <div className="flex items-center gap-3">
    ...
    <div className="text-sm font-black text-[#7a6500]">
      {activeStep + 1} / {steps.length}
                ...
                <div className="mb-4 animate-pulse text-center text-sm font-bold text-amber-600">
                ...
                <div className="space-y-3">
                  {steps.map((step, i) => (
                    <button
                      ...
                      className={`group flex w-full cursor-pointer items-start gap-4 rounded-2xl border p-4 text-left transition ${
                        activeStep === i
                    ...
                    >
                      ...
                      <div className="ml-auto text-amber-500 opacity-0 transition group-hover:opacity-100">
                        →
                      </div>
                    </button>
                  ))}
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <div className="mt-4">
                    <BrochureLink
                      href="/brochures/axis-overview.pdf"
                      label="View Full System Brochure"
                    />
                  </div>

               <div className="relative mt-6 overflow-hidden rounded-2xl border border-[#ece7d2] bg-[#f5f5f0]">
  ...
  <div className="absolute inset-0 bg-black/10 pointer-events-none" />
    ...
    <section id="cloud" className="border-t border-[#ddd9c8] bg-[#efefea] px-6 py-24 md:px-10">
          <div className="mx-auto max-w-7xl">
            <div className="mb-10 text-center">
              <div className="text-xs font-black uppercase tracking-[0.3em] text-[#8b7a20]">
              ...
              <div className="rounded-[2rem] border border-[#ddd7c0] bg-white p-6 shadow-xl">
                ...
                <div className="overflow-hidden rounded-[1.6rem] border border-[#ece7d2] bg-[#faf8ef]">
                  ...
                  <div className="px-6 pt-5">
                    <BrochureLink
                      href="/brochures/cloud-connect.pdf"
                      label="View Cloud Solution Brochure"
                    />
                  </div>
          ...
          <div className="mx-auto max-w-7xl">
            <div className="grid gap-8 lg:grid-cols-[1.02fr_0.98fr]">
              <div className="rounded-[2rem] border border-[#ddd7c0] bg-white p-6 shadow-xl">
                ...
                <div className="flex items-center justify-center overflow-hidden rounded-[1.6rem] border border-[#ece7d2] bg-[#faf8ef]">
                  <img
                    src="/images/ai-bodycam.png"
                    alt="Security officer wearing a body camera in a school hallway"
                ...
                <div className="mt-4">
                  <BrochureLink
                    href="/brochures/bodycam-solution.pdf"
                    label="View Body Camera Brochure"
                  />
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-[2rem] border border-[#e3d99b] bg-[#fff8d8] p-7 shadow-xl">
                  <div className="text-xs font-black uppercase tracking-[0.22em] text-[#7a6500]">
                    Best-fit use cases
                  </div>
                  <div className="mt-4 grid gap-3">
                    {[
                      ...
                      "After-hours and event supervision",
                      "Student incident response and investigation support",
                      "Campus-wide safety programs needing mobile coverage",
                    ].map((item) => (
                      <div
                        key={item}
                        className="rounded-xl border border-[#eadfa7] bg-white/70 px-4 py-3 text-sm font-semibold text-[#374151]"
                      >
                        {item}
                      </div>
                    ))}
